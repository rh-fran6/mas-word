...
class VaultSecretProvider(SecretProvider):
    ...
    def __init__(self, addr: str, token_env: str = "VAULT_TOKEN") -> None:  # noqa: S107
        self.addr = addr
    ...
    def set_secret(self, ref: str, value: str) -> None:
        ...
        key = parts[-1] if len(parts) > 1 else "value"
        try:
            existing = client.secrets.kv.v2.read_secret_version(mount_point=mount, path=secret_path)
